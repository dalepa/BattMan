...
void tempToInflux()
{
      ...
      String line = String("BattMan.victron.HQ2212CHJG2-shunt.battery.temperature value=" + String(temperature));
      toInflux(line);
      line = String("BattMan.victron.HQ2212CHJG2-shunt.battery.humidity value=" + String(humidity));
      toInflux(line);
